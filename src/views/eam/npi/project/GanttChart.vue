...
.gantt-scroll { overflow-x: auto; border: 1px solid #E5E6EB; border-radius: 4px; }
.gantt-table { display: inline-flex; flex-direction: column; min-width: 100%; }
...
.gantt-header-row1, .gantt-header-row2 { position: sticky; top: 0; z-index: 2; background: #F5F7FA; }
...
.gantt-timeline { position: relative; flex-shrink: 0; height: 56px; border-bottom: 1px solid #EBEEF5; }
